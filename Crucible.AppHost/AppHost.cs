...
public static class BuilderExtensions
{
    ...
    private static Dictionary<string, string>? ReadAwsCredentials()
    {
        ...
        var creds = ReadAwsStaticCredentials(Path.Combine(awsDir, "credentials"))
            ?? ReadAwsSsoCredentials(Path.Combine(awsDir, "sso-credentials"));
    ...
    /// </summary>
    private static Dictionary<string, string>? ReadAwsStaticCredentials(string credentialsPath)
    {
    ...
    /// </summary>
    private static Dictionary<string, string>? ReadAwsSsoCredentials(string credentialsPath)
    {
        if (!File.Exists(credentialsPath))
        {
            return null;
    ...
    private static Dictionary<string, string> NewAwsCredentials() => new()
    {
        ["aws_access_key_id"] = "",
