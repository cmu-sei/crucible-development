...
echo ""
echo "To automatically update appsettings files:"
echo "  PROXMOX_HOST=$PROXMOX_HOST PROXMOX_TOKEN='$TOKEN_USER!$TOKEN_ID=$TOKEN_VALUE' ./scripts/update-proxmox-appsettings.sh"
echo ""
echo "Next steps:"
echo "  # Download an ISO and create a VM:"
echo ""
echo "  # Alpine Linux:"
echo "  PROXMOX_HOST=$PROXMOX_HOST ./scripts/download-alpine-iso.sh"
echo "  PROXMOX_HOST=$PROXMOX_HOST ./scripts/create-alpine-vm.sh"
echo ""
echo "  # Puppy Linux:"
echo "  PROXMOX_HOST=$PROXMOX_HOST ./scripts/download-puppy-iso.sh"
echo "  PROXMOX_HOST=$PROXMOX_HOST ./scripts/create-puppy-vm.sh"
echo ""
echo "  # TinyCore Linux:"
echo "  PROXMOX_HOST=$PROXMOX_HOST ./scripts/download-tinycore-iso.sh"
